...
import legendSkinsSection from './LegendSkinsSection'
...
export const LegendSkinItem = SkinItem
export const LegendAbilityCard = AbilityCard
export const LegendLoadingScreenItem = LoadingScreenItem
export const LegendBioSection = legendBioSection
